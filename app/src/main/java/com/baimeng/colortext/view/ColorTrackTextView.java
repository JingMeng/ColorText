package com.baimeng.colortext.view;
...
//     * @param middle
//     */
//    private void drawOrginText(float middle ,Canvas canvas) {
//        //范围 middle - getWidth
//        canvas.save() ;
//        //绘制截取部分（变色）
//        canvas.clipRect(new RectF(middle,0,getWidth(),getHeight()));
//        //drawText 参数x 是字体的最左边的位置，等于控件宽度的一半减去字体宽度的一半
//        String text = getText().toString();
//        Rect rect = new Rect() ;
//        mChangePaint.getTextBounds(text,0,text.length(),rect);
//        int textWidth = rect.width();
//        int x = getWidth()/2 - textWidth/2 ;
//        canvas.drawText( text , x ,getHeight()/2,mOriginPaint);
//        canvas.restore();
//    }
//
//    /**
...
//     * @param middle
//     */
//    private void drawChangeText(float middle ,Canvas canvas) {
//        //范围 0 - middle
//        canvas.save() ;
//        //绘制截取部分（变色）
//        canvas.clipRect(new RectF(0,0,middle,getHeight()));
//        //drawText 参数x 是字体的最左边的位置，等于控件宽度的一半减去字体宽度的一半
//        String text = getText().toString();
//        Rect rect = new Rect() ;
//        mChangePaint.getTextBounds(text,0,text.length(),rect);
